...
export async function POST(req: Request) {
    try {
        ...
        const promptParts = [
            ...
            `- **TABLA RESUMEN DE RECOMENDACIONES (AL FINAL)**: Incluye una tabla con las columnas: | Fondo | ISIN | Acción Recomendada | Motivo |. En "Acción Recomendada" usa iconos: 🟢 Mantener, 🔴 Vender, 🟡 Traspasar / Bajo Vigilancia.`,
            ``,
