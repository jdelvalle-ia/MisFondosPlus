...
export async function POST(req: Request) {
    try {
        ...
        const promptParts = [
            ...
            `2. **VERIFICACIÓN**: Si no tienes la certeza absoluta del ISIN o del nombre exacto del fondo en su clase en EUROS, indícalo claramente o busca una alternativa de la que sí tengas datos en el contexto de mercado o en tu base de conocimientos actualizada.`,
            `3. **REQUISITO DE MONEDA Y PLATAFORMA**: Verifica mentalmente que el ISIN corresponde a la clase "Euro" del fondo y que se comercializa en España vía Bankinter o está listado en Morningstar España.`,
            ``,
